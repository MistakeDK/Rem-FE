    ...
    return (
        <div className='flex justify-center p-4 min-h-screen'>
            <div className='w-11/12'>
                <div className='flex'>
                    <div className='flex-col border  bg-gray-100 w-4/12 shadow-custom h-80 pt-2 lg:flex hidden'>
                    ...
                    <div className='flex flex-col rounded-lg border mx-2 lg:w-11/12 border-gray-950 p-2'>
                        <Outlet />
                    </div>
                </div>
            </div>
